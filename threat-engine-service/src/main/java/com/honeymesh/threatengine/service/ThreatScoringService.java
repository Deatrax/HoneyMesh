...
public class ThreatScoringService {
    ...
    /**
     * Evaluates a CorrelationSnapshot to compute a ThreatAssessment.
     * Pure business logic: zero external I/O or state mutations.
     */
    public ThreatAssessment assess(CorrelationSnapshot snapshot) {
        ...
        // 2. Frequency Bonus (highest applicable tier only)
        ...
        // 3. Distinct Decoy Bonus (highest applicable tier only)
        ...
        // 5. Map final score to ThreatLevel
